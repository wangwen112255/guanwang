...
class Page{
    ...
    private $config  = array(
        'header' => '<li><a>共查到 %TOTAL_ROW% 条</a></li>',
        'prev'   => '&laquo;',
        'next'   => '&raquo;',
        'first'  => '1...',
        'last'   => '...%TOTAL_PAGE%',
    ...
    public function show() {
        ...
        $page_str = str_replace(
            ...
            array($this->config['header'], $this->nowPage, $up_page, $down_page, $the_first, $link_page, $the_end, $this->totalRows, '<li><a>共有'.$this->totalPages.'页</a></li>'),
            $this->config['theme']);
