...
class TypeEvent{
	...
	public function qq($token){
		$qq=new \Org\ThinkSDK\sdk\QqSDK($token);
	...
	public function sina($token){
		$oauth=new \ThinkSDK\OauthSDK\sdk\SinaSDK($token);
	...
	public function renren($token){
		$renren=new \ThinkSDK\OauthSDK\sdk\RenrenSDK($token);
	...
	public function x360($token){
		$x360=new \ThinkSDK\OauthSDK\sdk\X360SDK($token);
	...
	public function douban($token){
		$douban=new \ThinkSDK\OauthSDK\sdk\DoubanSDK($token);
	...
	public function github($token){
		$github=new \ThinkSDK\OauthSDK\sdk\GithubSDK($token);
	...
	public function taobao($token){
		$taobao=new \ThinkSDK\OauthSDK\sdk\TaobaoSDK($token);
	...
	public function baidu($token){
		$baidu=new \ThinkSDK\OauthSDK\sdk\BaiduSDK($token);
