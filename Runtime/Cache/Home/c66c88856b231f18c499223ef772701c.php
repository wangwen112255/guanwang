                  ...
                  <nav class="collapse navbar-collapse menu" >
                     <ul class="nav navbar-nav sf-menu">
                        <li>
                           ...
                           <eq name="nav" value="Index">ThinkPHP</eq>
                           首页
                           </a>
                        </li>
                        <li>
                           <a href="<?php echo U('Service/index');?>" class="sf-with-ul">
                          服务介绍
                           </a>
                        </li>
                        <li>
                           <a href="<?php echo U('Case/index');?>" class="sf-with-ul">
                           案例展示
                           </a>
                        </li>
                         <li>
                           <a href="<?php echo U('Build/index');?>" class="sf-with-ul">
                           定制开发 
                           </a>
                        </li>
                        <li>
                           <a href="<?php echo U('Recruit/index');?>" class="sf-with-ul">
                           诚聘英才 
                           </a>
                        </li>
                         <li>
                           <a href="<?php echo U('Contact/index');?>" class="sf-with-ul">
                           联系我们 
                           </a>
                        </li>
                     </ul>
