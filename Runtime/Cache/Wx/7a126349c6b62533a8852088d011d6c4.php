...
<form action="<?php echo U('intro');?>" id='signupForm' method="post">
    <div style="margin:28px; margin-bottom:15px;" class="hui-form" >
        <div class="hui-form-items">
            <input type="text" class="hui-input hui-input-clear" value="<?php echo ($Userdata['realname']); ?>" placeholder="真实姓名" checkType="string" checkData="2,5"  id='realname' checkMsg="真实姓名一般是三到五个汉字" />
        </div>
        <div class="hui-form-items">
